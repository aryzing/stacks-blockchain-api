...
export const BlockWithMicroblocksSchema = Type.Object(
  {
    canonical: Type.Boolean({
      description: 'Set to `true` if block corresponds to the canonical chain tip',
    }),
    ...
    microblocks_accepted: Type.Array(Type.String(), {
      description:
    ...
    microblocks_streamed: Type.Array(Type.String(), {
      description:
  ...
  { title: 'BlockWithMicroblocks', description: 'A block' }
);
export type BlockWithMicroblocks = Static<typeof BlockWithMicroblocksSchema>;
