...
export const TransactionIdParamSchema = Type.RegEx(/^(0x)?[a-fA-F0-9]{64}$/i, {
  title: 'Transaction ID',
  description: 'Transaction ID',
  examples: ['0xf6bd5f4a7b26184a3466340b2e99fd003b4962c0e382a7e4b6a13df3dd7a91c6'],
});

export const BlockHashSchema = Type.RegEx(/^(0x)?[a-fA-F0-9]{64}$/i, {
  title: 'Block hash',
...
export const BurnBlockHashParamSchema = Type.RegEx(/^(0x)?[a-fA-F0-9]{64}$/i, {
  title: 'Burn block hash',
  description: 'Burn block hash',
  examples: ['0000000000000000000452773967cdd62297137cdaf79950c5e8bb0c62075133'],
});

export const BurnBlockHeightParamSchema = Type.RegEx(/^[0-9]+$/, {
  title: 'Burn block height',
  description: 'Burn block height',
  examples: ['777678'],
});

export const AddressParamSchema = Type.RegEx(/^[0123456789ABCDEFGHJKMNPQRSTVWXYZ]{28,41}/, {
  title: 'STX Address',
  description: 'STX Address',
  examples: ['SP318Q55DEKHRXJK696033DQN5C54D9K2EE6DHRWP'],
});

export const SmartContractIdParamSchema = Type.RegEx(
